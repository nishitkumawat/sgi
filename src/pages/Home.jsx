    ...
    <div className="bg-white min-h-screen">
      ...
      <section className="py-32 px-6 bg-[#f0f4f8] border-t border-slate-200 overflow-hidden relative">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10 bg-white p-16 shadow-xl border-t-4 border-blue-700">
          <img src={logo} alt="SGI Logo" className="w-20 mx-auto mb-10 opacity-80" />
          ...
          <Link to="/about" className="inline-flex items-center gap-4 px-10 py-4 font-black bg-blue-700 text-white hover:bg-slate-900 transition-colors text-sm uppercase tracking-widest">
            Our Legacy Story
          </Link>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto py-24 px-8 bg-slate-900 relative overflow-hidden text-center shadow-2xl border-b-8 border-blue-700">
          ...
          <div className="relative z-10 max-w-2xl mx-auto">
            ...
            <div className="flex flex-wrap gap-5 justify-center">
              <Link to="/contact" className="px-10 py-4 font-extrabold bg-blue-700 text-white hover:bg-blue-600 transition-colors text-sm uppercase tracking-widest">
                Start Consultation
              </Link>
              <a href="tel:+919825435437" className="px-10 py-4 font-extrabold border-2 border-slate-600 text-white hover:bg-slate-800 transition-colors text-sm uppercase tracking-widest flex items-center gap-3">
                📞 Call Inquiry
              </a>
            </div>
          </div>
