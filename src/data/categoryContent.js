export const CATEGORY_CONTENT = {
  'roll-forming': {
    applications: [
      { 
        ...
        image: 'https://images.unsplash.com/photo-1504307651254-35680f4a8f52?auto=format&fit=crop&q=80&w=800'
      },
      { 
        title: 'Roofing & Cladding', 
        desc: 'Precision trapezoidal and corrugated sheets for industrial warehouses.',
        image: 'https://images.unsplash.com/photo-1590483734748-3611d9310860?auto=format&fit=crop&q=80&w=800'
      },
      { 
      ...
      { 
        ...
        image: 'https://images.unsplash.com/photo-1444858291040-58f756a3bcd6?auto=format&fit=crop&q=80&w=800'
      }
    ],
    facility: {
    ...
    subsections: [
      { title: 'C Channels', icon: 'metric', image: 'https://5.imimg.com/data5/SELLER/Default/2021/3/MF/MA/TX/10097291/c-channel-roll-forming-machine-500x500.jpg' },
      { title: 'Z Purlins', icon: 'metric', image: 'https://5.imimg.com/data5/ECOM/Default/2023/10/356394154/ST/YJ/RE/10097291/whatsappimage2023-10-09at1-31-01pm-500x500.jpg' },
      { title: 'Solar Mounting Rails', icon: 'solar', image: 'https://5.imimg.com/data5/ANDROID/Default/2021/3/WG/PS/OK/10097291/product-500x500.jpg' },
      { title: 'Strut Channels', icon: 'structural', image: 'https://5.imimg.com/data5/SELLER/Default/2021/3/AW/KU/DG/10097291/mcb-channel-roll-forming-machine-500x500.jpg' },
      { title: 'Custom Roll Formed Sections', icon: 'custom', image: 'https://5.imimg.com/data5/SELLER/Default/2021/3/WO/OD/QR/10097291/customised-roll-forming-machine-500x500.jpg' }
    ],
    quality: [
  ...
  'solar': {
    ...
    subsections: [
      ...
      { title: 'Panel Frame Machinery', icon: 'metric', image: 'https://5.imimg.com/data5/SELLER/Default/2021/3/WO/OD/QR/10097291/customised-roll-forming-machine-500x500.jpg' }
    ],
    quality: [
  ...
  'shutter-motors': {
    applications: [
      ...
      { 
        ...
        image: 'https://images.unsplash.com/photo-1542362567-b05500269774?auto=format&fit=crop&q=80&w=800'
      },
      { 
        title: 'Emergency Shutters', 
        desc: 'Fast-acting shutters for fire safety and high-security zones.',
        image: 'https://images.unsplash.com/photo-1562322140-8baeececf3df?auto=format&fit=crop&q=80&w=800'
      }
    ],
    facility: {
      location: 'Ahmedabad Assembly Center',
      size: '10,000 sq. ft.',
    ...
    subsections: [
      { title: 'Single Phase Side Motors', icon: 'electric', image: 'https://5.imimg.com/data5/SELLER/Default/2021/3/MT/VX/ZI/10097291/single-phase-rolling-shutter-side-motor-500x500.jpg' },
      { title: 'High Torque Geared Motors', icon: 'gear', image: 'https://5.imimg.com/data5/ANDROID/Default/2021/3/YF/IU/WW/10097291/product-500x500.jpg' },
      { title: 'Remote Control Systems', icon: 'remote', image: 'https://5.imimg.com/data5/SELLER/Default/2021/3/RW/OZ/ZA/10097291/motorized-rolling-shutter-motor-500x500.jpg' }
    ],
    quality: [
