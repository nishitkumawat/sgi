...
import cpurlinImg1 from "../assets/c_machine2.png";
import cpurlinImg2 from "../assets/c_machine.png";
import cpurlinImg3 from "../assets/cpurlin_3.png";
import decoilerImg from "../assets/decoiler2.png";
import punchingMachineImg from "../assets/straight.png";
import punchingMachine2Img from "../assets/punching_machine_2.png";
import hatSection1Img from "../assets/hat_machine.png";
import hatSection2Img from "../assets/cutter.png";
import hatSection3Img from "../assets/hat_4.png";
import hatSection4Img from "../assets/hat_5.jpeg";
import cuttingSystemImg from "../assets/cutter.png";
import controlPanelImg from "../assets/plc.png";
import controlPanel2Img from "../assets/plc2.jpeg";
import hydraulicPowerPackImg from "../assets/bluemotor.png";
import machine1Img from "../assets/machine.jpeg";
import machine2Img from "../assets/machine2.jpeg";
import strutMachineImg from "../assets/strut_machine1.png";
import strutMachine2Img from "../assets/strut_machine2.png";
import strutMachine3Img from "../assets/sturt.png";
import sectionImg from "../assets/section_4.png";
...
export const PRODUCT_IMAGES = {
  ...
  "strut-machine2": strutMachine2Img,
  "strut-machine3": strutMachine3Img,
...
export const PRODUCTS = [
  // ─── ROLL FORMING MACHINES ──────────────────────────────────────────
  {
    ...
    badge: "Popular",
    image: PRODUCT_IMAGES["cpurlin-2"],
    images: [
      PRODUCT_IMAGES["cpurlin-1"],
      PRODUCT_IMAGES["cpurlin-2"],
      PRODUCT_IMAGES["section"],
      PRODUCT_IMAGES["cpurlin-3"],
    ],
    description:
      "High-performance C Purlin Roll Forming Machine with auto size adjustment for PEB buildings, industrial sheds and solar structures. Features 19-station forming, servo motor drive, and PLC-controlled automatic cutting.",
    specs: [
      { label: "Suitable Material", value: "M.S., G.P., H.R., GALVANIUM" },
      { label: "Thickness of Raw Material", value: "1.60 mm to 2.50 mm" },
      {
        label: "Section Web (A) Size",
        value: "60 to 250 mm (Auto Size Adjustment)",
      },
      {
        label: "Section Flange (B) Size",
        value: "40 to 80 mm (Auto Size Adjustment)",
      },
      ...
      { label: "Roller Material", value: "EN-31 (Hard with hard crome)" },
      {
        label: "Productivity",
        value:
          "41 mtr/min (without punching) ; 6 to 12 mtr/min (with punching)",
      },
      ...
      {
        label: "Section Tolerance",
        value: "± 1 to 2 mm on length, bending & Twisting",
      },
      {
        label: "Tolerance",
        value: "± 1 to 2 mm on length, bending & Twisting",
    ...
    features: [
      "Auto size adjustment for web & flange",
      "19-station precision forming",
      "22 KW Servo motor drive",
      "Hardened EN-31 rollers with hard chrome",
      "PLC automatic cutting system",
      "Chain drive + 9 gear box transmission",
    ],
  },
  {
    ...
    images: [
      PRODUCT_IMAGES["hat-section-1"],
      PRODUCT_IMAGES["hat-section-2"],
      PRODUCT_IMAGES["hat-section-3"],
      PRODUCT_IMAGES["hat-section-4"],
    ],
    description:
      "High-productivity Hat Section Roll Forming Machine for solar mounting structures. Features 16-station forming, servo motor drive, and automatic PLC cutting. Produces 8-10 tons per day with punching.",
    specs: [
      ...
      {
        label: "Height of Material",
        value: "60 to 120 mm (Manually Changeable)",
      },
    ...
    features: [
      "16-station precision forming",
      "8-10 ton/day productivity",
      "Servo motor 11-15 KW drive",
      "EN-31 hardened rollers",
      "PLC automatic cutting",
      "Manually adjustable height 60-120 mm",
    ],
  },
  {
    ...
    badge: "New",
    image: PRODUCT_IMAGES["strut-machine"],
    images: [
      PRODUCT_IMAGES["strut-machine"],
      PRODUCT_IMAGES["strut-machine2"],
      PRODUCT_IMAGES["strut-machine3"],
    ],
    description:
      "High-performance Strut Channel Roll Forming Machine designed for manufacturing robust strut channels. Features 15-station forming, chain drive transmission, and automatic cutting systems.",
    specs: [
    ...
    features: [
      "15-station precision forming",
      "Auto-size changer (01-07 stations)",
      "15 HP 3-phase motor power",
      "EN31 hardened rollers",
  ...
  },
  {
    ...
    description:
      "Robust manual hydraulic de-coiler with 5-ton capacity and hydraulic mandrel expansion. Designed for reliable coil feeding in roll forming production lines with adjustable drum expansion range.",
    specs: [
    ...
    features: [
      "5-ton weight capacity",
      "Hydraulic cylinder mandrel expansion",
      "600 mm max feeding width",
      "Adjustable drum expansion range",
  ...
  },
  {
    ...
    images: [
      PRODUCT_IMAGES["punching-machine"],
      PRODUCT_IMAGES["punching-machine-2"],
    ],
    description:
      "Advanced 4-cylinder punching machine with integrated 7-roller straightening system. Features WPS punch & die material, multiple punch size configurations, and hard chrome EN-31 straightening rollers.",
    specs: [
    ...
    features: [
      "4-cylinder multi-punch system",
      "WPS grade punch & die",
      "7-roller integrated straightening",
      "80 mm hard chrome EN-31 rollers",
      "Multiple interchangeable punch sets",
...

  {
    ...
    description:
      "Heavy-duty automatic cutting system with hydraulic-operated cutting press and anti-friction guide way. Features high-speed operation with sensor-controlled precision for roll forming production lines.",
    specs: [
  ...
  },
  {
    ...
    description:
      "Advanced PLC control panel with high-accuracy length control in both MM and inch. Features auto single piece system, auto braking, and automatic machine length counting from front to back shear.",
    specs: [
    ...
    features: [
      "PLC high-accuracy length control",
      "MM & inch measurement",
      "Auto single piece system",
      "Auto braking system",
      "Auto machine length counting",
      "24VDC SMPS power supply",
    ],
  },
  {
    ...
    description:
      "Complete hydraulic power pack system powering 4 punches, 2 shearing units and 1 de-coiler. Features 150-litre tank capacity with solenoid direction control valves and 7.5 HP motor.",
    specs: [
    ...
    features: [
      "Powers complete production line",
      "150-litre hydraulic tank",
      "Solenoid direction control valves",
      "7.5 HP heavy-duty motor",
      "Supports 4 punches + 2 shearing + de-coiler",
    ],
  },
  // ─── MOTORS & ACCESSORIES ──────────────────────────────────────────
  {
    ...
    images: [
      PRODUCT_IMAGES["single-phase-motor"],
      PRODUCT_IMAGES["single-phase-motor1"],
    ],
    description:
      "Reliable and efficient single-phase rolling Rolling Shutter Gear Motor. Perfect for standard commercial and residential rolling shutters. Built with robust materials for extended lifespan.",
    specs: [
  ...
  },
  {
    ...
    images: [
      PRODUCT_IMAGES["three-phase-motor"],
      PRODUCT_IMAGES["three-phase-motor1"],
    ],
    description:
      "Powerful three-phase motor designed for large industrial and heavy commercial rolling shutters. Delivers superior torque and continuous operational capacity.",
    specs: [
  ...
  },
  {
    ...
    description:
      "Standard Up/Down/Stop push button station for hardwired manual control of rolling Rolling Shutter Gear Motors. Highly durable industrial enclosure.",
    specs: [
  ...
  },
  {
    ...
    description:
      "High-security physical key lock selector for manual operation override. Ensures only authorized personnel can open or close the automated shutter.",
    specs: [
  ...
  },
  {
    ...
    description:
      "Convenient wireless remote control system compatible with our single and three-phase motors. Provides secure and long-range operational control.",
    specs: [
  ...
  },
  {
    ...
    description:
      "EzRun Smart Keypad Controller. Integrate your rolling shutter into a modern smart building ecosystem. Control directly via mobile app from anywhere in the world.",
    specs: [
      { label: "Connectivity", value: "WiFi / Internet" },
      { label: "Features", value: "Mobile App Control" },
    ],
    features: [
      "EzRun App Integration",
